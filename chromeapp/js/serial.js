...
var serial_lib=(function() {
  ...
  var onCharRead=function(readInfo) {
    ...
    //chrome.serial.read(connectionInfo.connectionId, onCharRead);
    //serial.read(integer connectionId, integer bytesToRead, function ReadCallback) 
  }
  ...
  var openSerial=function(serialPort, bitrate, callback) {
    chrome.serial.open(serialPort, { bitrate: bitrate}, function(cInfo) {
